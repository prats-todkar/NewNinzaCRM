...
public class CreateProductTestWithGroups extends BaseClassWithGroups {
...
//		sc.selectByValue("Electronics");
		...
		WebElement category = cpp.getProdCategory();
		wLib.select(category, "Electronics");
...
//		sc1.selectByValue("VID_466");
		...
		WebElement vendor = cpp.getVendorId();
		wLib.select(vendor, "VID_466");
